...
class Osoba(models.Model):
     ...
     cp_celkova_cena_limit = fields.Float(digits=(6,0), string="Celková cena cenovej ponuky", help="Cenový limit cenovej ponuky, pri ktorého prekročení musí CP schváli%t danaá osoba", default=0);
